...
// Sub-componente para los selectores de días (Multi-select)
...
const ModalNuevaMateria = ({ isOpen, onClose, onSave }) => {
  const [nombre, setNombre] = useState('');
  
  // ESTA ES TU PLANTILLA FLEXIBLE
  // Si añades un objeto aquí, aparecerá en TODAS las materias
  const [fields, setFields] = useState([
    { id: 'prof', label: 'Profesor', type: 'text', value: '', icon: '👨‍🏫' },
    { id: 'dias', label: 'Días de Clase', type: 'multi-select', value: [], icon: '📅' },
    { id: 'hora', label: 'Horario', type: 'select', value: '', icon: '⏰', options: ['7:00 AM', '9:00 AM', '11:00 AM', '1:00 PM'] }
  ]);
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="text-[10px] uppercase tracking-[0.2em] text-gray-500 font-black ml-1">Nombre Principal</label>
                <input 
                  autoFocus
              ...
              {/* Renderizado Dinámico de Campos Secundarios */}
                  ...
                  <div key={field.id} className="bg-[#1e1e1e]/40 p-4 rounded-2xl border border-white/5">
                    ...
                    {field.type === 'select' && (
                      <select 
                        ...
                        onChange={(e) => updateField(field.id, e.target.value)}
                      >
                        <option value="" className="bg-[#242424]">Seleccionar horario...</option>
            ...
            <div className="mt-10 flex gap-4">
              ...
              <button 
                ...
                className="flex-1 py-4 rounded-2xl bg-blue-600 text-white hover:bg-blue-500 transition-all font-bold shadow-xl shadow-blue-900/40 border-t border-white/20"
              >
                Guardar Materia
              </button>
            </div>

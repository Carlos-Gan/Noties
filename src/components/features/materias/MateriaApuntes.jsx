...
const MateriaApuntes = ({
  ...
  return (
    <div className="flex h-full bg-[#1a1a1a] text-white font-sans">
      {/* ─── Sidebar izquierdo con lista de notas ─── */}
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        {notaActiva ? (
          <>
            {/* Header fijo del apunte */}
            <div className="p-10 pb-6 flex flex-col gap-6 flex-shrink-0">
                        ...
                        <div className="absolute top-full left-0 mt-2 w-44 bg-[#1f1f1f] border border-white/10 rounded-xl shadow-2xl py-2 z-50">
                          {[
                            ...
                            <button
                              ...
                              className={`w-full text-left px-4 py-2 text-[10px] font-bold uppercase transition-colors ${
                                unidad === u
                                  ? "bg-blue-600"
            ...
            {/* Contenido con scroll — editor + tareas + proyectos */}
